...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        # replicas
        topic_name = f"{self.TOPIC_BASE_NAME}.weather.v1"
        super().__init__(
            topic_name,
    ...
    def run(self, month):
        ...
        resp = requests.post(
           # TODO: (done) What URL should be POSTed to?
           f"{Weather.rest_proxy_url}/topics/{self.topic_name}",
           # TODO: (done) What Headers need to bet set?
        ...
        try:
            ...
            logger.error(f"Error getting response from Kafka REST Proxi: {json.dumps(resp.json(), indent=2)}")
            exit(1)
